(***********************************************************)
(* Unicoq plugin.                                          *)
(* Copyright (c) 2015 Beta Ziliani <beta.ziliani@gmail.com>      *)
  ...
  *)
  ...
  and compare_heads conv_t env nparams c nparams' c' (dbg, sigma0) =
    ...
    | Case (ci1, u1, pms1, p1, iv1, c1, cl1), Case (ci2, u2, pms2, p2, iv2, c2, cl2) ->
      let (ci1, (p1,_), _, c1, cl1) = EConstr.expand_case env sigma0 (ci1, u1, pms1, p1, iv1, c1, cl1) in
      let (ci2, (p2,_), _, c2, cl2) = EConstr.expand_case env sigma0 (ci2, u2, pms2, p2, iv2, c2, cl2) in
      report (
